					...
					<table class="weather-col" width="110" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 110px; margin:0; background-color:#FFF;">
						<tr>
							<td class="weather-icon-date" style="width:60px">
								...
								<img class="weather-icon" src="<?php echo GMUCF_THEME_IMG_URL; ?>/weather/<?php echo $weather['day1']['imgCode']; ?>.png" />
							</td>
					...
					<table class="weather-col" width="110" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 110px; margin:0; background-color:#FFF;">
						<tr>
							<td class="weather-icon-date" style="width:60px">
								...
								<img class="weather-icon" src="<?php echo GMUCF_THEME_IMG_URL; ?>/weather/<?php echo $weather['day2']['imgCode']; ?>.png" />
							</td>
							<td class="weather-temps">
					...
					<table class="weather-col" width="110" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 110px; margin:0; background-color:#FFF;">
						<tr>
							<td class="weather-icon-date" style="width:60px">
								...
								<img class="weather-icon" src="<?php echo GMUCF_THEME_IMG_URL; ?>/weather/<?php echo $weather['day3']['imgCode']; ?>.png" />
							</td>
							<td class="weather-temps">
					...
					<table class="weather-col" width="110" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 110px; margin:0; background-color:#FFF;">
						<tr>
							<td class="weather-icon-date" style="width:60px">
								...
								<img class="weather-icon" src="<?php echo GMUCF_THEME_IMG_URL; ?>/weather/<?php echo $weather['day4']['imgCode']; ?>.png" />
							</td>
							<td class="weather-temps">
					...
					<table class="weather-col" width="110" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 110px; margin:0; background-color:#FFF;">
						<tr>
							<td class="weather-icon-date" style="width:60px">
								...
								<?php } else { ?>
									<img class="weather-icon" src="<?php echo GMUCF_THEME_IMG_URL; ?>/weather/<?php echo $weather['day5']['imgCode']; ?>.png" />
								<?php } ?>
							</td>
							<td class="weather-temps">

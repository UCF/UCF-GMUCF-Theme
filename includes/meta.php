...
function enqueue_frontend_assets() {
	...
	$style_deps = array();
	if ( class_exists( 'GFForms' ) && defined( 'ATHENA_GF__PLUGIN_FILE' ) ) {
		$style_deps[] = 'athena_gf_css';
	}
	wp_enqueue_style( 'style', GMUCF_THEME_CSS_URL . '/style.min.css', $style_deps, $theme_version );

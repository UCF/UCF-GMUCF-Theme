...
if(!is_wp_error($rss)) {
	...
	?>
	<a href="<?=$rss_item->get_permalink()?>">
		<img style="border:none;" src="<?=$thumbnail?>" />
	</a>
	<table width="560" border="0" align="center" cellpadding="0" bgcolor="#FFF" cellspacing="0" style="width: 560px; margin:0 auto;padding-top:20px; background-color:#FFF;border-bottom:1px solid #ddd;">
		<tr>
			<td colspan="2" style="padding-bottom:15px;">
				<a href="<?=$rss_item->get_permalink()?>"  style="color:#333;text-decoration:none;">
					<span style="font-size:30px;font-weight:100;"><?=$rss_item->get_title()?></span>
